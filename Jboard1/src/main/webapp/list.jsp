...
request.setCharacterEncoding("UTF-8");
	String pg = request.getParameter("pg"); // 페이지가 2가 되면
	...
	// 현재 페이지 계산
	if(pg != null){
		currentPage = Integer.parseInt(pg); // int 2로 변환
		
	}
	// Limit 시작값 계산
	start = (currentPage -1) * 10; // 해당 페이지가 1이 되면서 10이 곱해진다
	...
	// 현재 페이지 게시물 조회
	List<ArticleDTO> articles = dao.selectArtcles(start);
%>
<main>
    <section class="list">
        <h3>글목록</h3>
