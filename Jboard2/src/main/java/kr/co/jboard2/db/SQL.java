...
public class SQL {
	// user
		...
		public final static String UPDATE_ARTICLE = "UPDATE `Article` SET "
														...
														+ "`content`=? "
														+ "WHERE `no`=?";
		public final static String UPDATE_ARTICLE_HIT_PLUS = "UPDATE `Article` SET `hit`=`hit`+1 WHERE `no`=?";
		...
		public final static String SELECT_FILE_ARTICLE = "SELECT * FROM `File` WHERE `ano`=?";
