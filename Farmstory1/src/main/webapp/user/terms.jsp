...
<body>
    <div id="container">
        <header>
            ...
            <ul class="gnb">
                <li><a href="./introduction/hello.jsp">팜스토리소개</a></li>
                <li><a href="./market/list.jsp"><img src="../images/head_menu_badge.png" alt="30%"/>장보기</a></li>
                <li><a href="./croptalk/story.jsp">농작물이야기</a></li>
                <li><a href="./event/event.jsp">이벤트</a></li>
                <li><a href="./community/notice.jsp">커뮤니티</a></li>
            </ul>
        </header>
        <div id="user">
